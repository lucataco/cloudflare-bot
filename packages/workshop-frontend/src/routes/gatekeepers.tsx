    ...
    <div className="relative isolate hidden h-[176px] w-[444px] lg:block">
      ...
      <div className="group absolute left-[176px] top-[58px] z-20">
        <button
          ...
          aria-label="A connection keeps app access limited to connected resources"
        >
...
function ConnectorsPage() {
  ...
  const handleOpenConnect = (vendorId: string) => {
    ...
    if (vendor?.description.configured === false) {
      toasts.add({
        title: `${vendor.description.displayName} isn't configured on this deployment yet.`,
        variant: 'error',
      })
      return
    }
        ...
        <header className="mb-8 grid gap-8 lg:grid-cols-[minmax(0,540px)_444px] lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-[14px] leading-[20px] font-normal tracking-[-0.25px] text-kumo-subtle">
              Connect the apps and accounts you want your bots to use, then choose
              what each bot can access.
            </p>
          </div>
        ...
        <div className="mb-6 flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Search apps and accounts…"
        ...
        {loadError && (
          <div className="rounded-2xl border border-kumo-line bg-kumo-base px-4 py-6 text-center">
            <p className="m-0 text-[13px] leading-[18px] font-medium tracking-[-0.25px] text-kumo-danger">
              Something went wrong loading your connected accounts.
            </p>
        ...
        {!initialLoading &&
          ...
          filteredAvailable.length === 0 && (
            <EmptyState
              title={
                search
                  ? 'No apps or accounts match'
                  : 'No apps or accounts available yet'
              }
              description={
                search
                  ? "We couldn't find anything matching your search."
                  : 'Apps and accounts will appear here as they become available to connect.'
              }
              icon={Plugs}
            />
          )}
