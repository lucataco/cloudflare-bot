/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1289b2ddaf619c1f64a63061168adb5d)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	WORKSPACES: R2Bucket;
	SANDBOX_TRANSPORT: "rpc";
	Sandbox: DurableObjectNamespace<import("./src/index").BotSandbox>;
	Workspaces: DurableObjectNamespace<import("./src/index").ComputerWorkspace>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BotSandbox" | "ComputerWorkspace";
	}
